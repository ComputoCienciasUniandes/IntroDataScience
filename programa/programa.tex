...
\noindent\normalsize El objetivo principal del curso es presentar métodos, proceso y algoritmos
...
\begin{itemize}
\item hacer hipótesis sobre las propiedades un conjunto de datos. \\[-0.6cm]   
\item  descartar hipótesis hechas sobre las propiedades un conjunto de datos.\\[-0.6cm]  
\\[-0.6cm]  
\end{itemize}
...
Presentaci\'on del curso. Relaciones entre iencia de datos, machine learning e inteligencia artificial.
\\[-0.3cm] % BISHOP 
...
De la Ciencia a la Ciencia de Datos. Charlas y testimonios.
% BISHOP 5
\\[-0.3cm]

\noindent\textbf{\textsc{Semana 14}}
Presentaciones con los enunciados de los retos.
Elección de los retos y conformación de equipos.
\\[-0.3cm]

\noindent\textbf{\textsc{Semana 15}}
Presentación de avance de soluciones de los retos.
\\[-0.3cm]

\noindent\textbf{\textsc{Semana 16}}
Presentación final de la solución de los retos.
\\[0.1cm]
...
\begin{itemize}
\item 3 Ejercicios ($25\%$ cada uno). Cada cuatro semanas se deja planteado un ejercicio para resolver. Solamente se evalúa el código y los resultados del código. 

\item Reto ($25\%$). El reto es un ejercicio abierto donde se da solución a una pregunta con las herramientas vistas en el curso. 
Se evalúa la claridad del planteamiento del problema, la relevancia del problema, la solidez de los experimentos computacionales para resolverlo y la claridad de la explicación de los resultados.
\end{itemize}
