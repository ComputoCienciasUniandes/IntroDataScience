...
Presentaci\'on del curso. Ajustes polinomiales. Probabilidad. Densidades de probabilidad. 
...
Entrop\'ia relativa e informaci\'on mutua.
\\[-0.3cm] % BISHOP
...
Redes Neuronales Convolucionales. Backpropagation para RNC.
% 8.1 Machine Learning Berkeley.
\\[-0.3cm]

\noindent\textbf{\textsc{Semana 13}}

Arquitecturas de RNC. Visualizaci\'on e interpretaci\'on de RNC.
% 8.2, 8.3. Machine Learning Berkeley
\\[-0.3cm]
